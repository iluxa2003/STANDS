...
var taskDescription = document.getElementsByClassName(
...
function showItems(json) {
  if (json.status === 'success') {
    ...
    json.database.forEach(function (item) {
      ...
      newTask.id = item.id;
      newTask.innerHTML = "\n        <span class='task-userName'>"
        .concat(item.user, "</span>\n        <span class='task-item__name'>")
        .concat(
          item.task,
...
function handleTaskClick(user, task, description, id) {
  ...
  console.log(data);
  modal.innerHTML =
    '\n      <button class="modal_close-botton" type="button" onclick="closeModal();">\n        Close\n      </button>\n      <div class="task">\n        <div class=\'task-userName\'>Username: '
      .concat(
        data.user,
        "</div>\n        <div class='task-item__name'>Task name: ",
      )
      .concat(
        data.task,
      ...
      .concat(
        data.description,
        '</div>\n      </div>\n      <button class="modal_delete-botton" type="button" onclick="deleteTask(',
      )
      .concat(data.id, ');">\n        Delete\n      </button>  \n    ');
